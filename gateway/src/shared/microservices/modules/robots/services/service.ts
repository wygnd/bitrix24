...
import { IRobotsYandexDirectQueryParams } from '../interfaces/yandex/direct/requests/invoice.interface';
import { IRobotsYandexDirectGenerateInvoiceResponse } from '@/shared/microservices/modules/robots/interfaces/yandex/direct/responses/interface';
...
export class RobotsService {
  ...
  public async sendRequestForGetInvoiceNumber(
  ...
  ): Promise<IRobotsYandexDirectGenerateInvoiceResponse> {
    ...
    return firstValueFrom<IRobotsYandexDirectGenerateInvoiceResponse>(
      observable,
    );
  }
}
