...
import { LEAD_OBSERVE_MANAGER_CALLING_TYPES } from '@/modules/bitrix/application/constants/leads/lead-observe-mananger-calling.constants';
...
export class LeadManagerCallingDto {
  @ApiProperty({
...
export class LeadObserveManagerCallingResponseDto implements LeadObserveManagerCallingResponse {
  @ApiProperty({
    type: Boolean,
...
export class LeadManagerCallDTO implements LeadObserveManagerCallingAttributes {
  @ApiProperty({
    type: Number,
